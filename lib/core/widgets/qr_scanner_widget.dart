      ...
      if (barcode.rawValue != null) {
        ...
        if (qrData == null) {
          ...
          if (RegExp(r'^[a-zA-Z0-9_-]+$').hasMatch(rawValue)) {
            ...
            debugPrint('Unknown format, treating as raw data: $rawValue'); // Debug log
