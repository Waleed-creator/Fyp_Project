  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AppUsageFirebase>>(
      ...
      builder: (context, snapshot) {
        ...
        final totalUsage = userApps.fold<int>(
          0,
          (sum, app) => sum + app.usageDuration,
        );
        final totalLaunches = userApps.fold<int>(
          0,
          (sum, app) => sum + app.launchCount,
        );
          ...
          appBar: AppBar(
            ...
            bottom: PreferredSize(
              ...
              child: TabBar(
                ...
                tabs: [
                  Tab(icon: Icon(Icons.apps), text: 'App Usage'),
  ...
  Widget _buildInstalledAppsTab() {
    return StreamBuilder<List<InstalledAppFirebase>>(
      ...
      builder: (context, snapshot) {
        ...
        debugPrint(
          '📱 [AppUsageHistoryScreen] Installed apps count: ${installedApps.length}',
        );
        if (installedApps.isEmpty) {
          debugPrint(
            '⚠️ [AppUsageHistoryScreen] No installed apps found in Firebase',
          );
