...
class InstalledAppsTabContent extends StatefulWidget {
  ...
  const InstalledAppsTabContent({super.key, 
  ...
  @override
  State<InstalledAppsTabContent> createState() =>
      _InstalledAppsTabContentState();
}
...
class _InstalledAppsTabContentState extends State<InstalledAppsTabContent> {
  ...
  Widget build(BuildContext context) {
    // Debug logging
    debugPrint('📊 [InstalledAppsTabContent] Building with:');
    debugPrint('   Total Apps: ${widget.allApps.length}');
    debugPrint('   User Apps: ${widget.userApps.length}');
    debugPrint('   System Apps: ${widget.systemApps.length}');
    debugPrint('   New Apps: ${widget.newApps.length}');
      ...
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            ...
            SizedBox(width: 12),
            Expanded(child: Text(app.appName, style: TextStyle(fontSize: 18))),
          ],
        ),
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow('Detected At', _formatDate(app.detectedAt)),
              if (app.isNewInstallation)
                Container(
