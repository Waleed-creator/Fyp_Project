...
class FcmBlockNotificationService {
  ...
  Future<void> notifyChildDeviceBlockUpdate({
    ...
    try {
      ...
      if (!childDoc.exists) {
        debugPrint('⚠️ Child document not found: $childId');
        return;
      }
      ...
      if (fcmToken == null || fcmToken.isEmpty) {
        debugPrint('⚠️ Child FCM token not found: $childId');
        return;
      }
      ...
      debugPrint('✅ FCM notification queued for child $childId');
    } catch (e) {
  ...
  Future<void> registerChildFcmToken({
    ...
    try {
      ...
      debugPrint('✅ FCM token registered for child $childId');
      ...
      _messaging.onTokenRefresh.listen((newToken) {
        ...
        debugPrint('✅ FCM token refreshed for child $childId');
      });
    } catch (e) {
