...
class UrlBlockingFirebaseService {
  ...
  Future<void> blockUrl({
    ...
    try {
      ...
      debugPrint('✅ URL blocked: $url for child $childId');
    } catch (e) {
      debugPrint('❌ Error blocking URL: $e');
      rethrow;
    }
  }
  ...
  Future<void> unblockUrl({
    ...
    try {
      ...
      if (ruleDoc.exists) {
        ...
        debugPrint('✅ URL unblocked: ${rule.url}');
      }
    } catch (e) {
      debugPrint('❌ Error unblocking URL: $e');
      rethrow;
    }
  }
  ...
  Future<List<BlockedUrlRule>> getBlockedUrls({
    ...
    try {
      ...
      debugPrint('❌ Error getting blocked URLs: $e');
      return [];
    }
  }
  ...
  Future<void> _updateVisitedUrlBlockStatus({
    ...
    try {
      ...
      debugPrint('⚠️ Error updating visited URL block status: $e');
  ...
  Future<void> _notifyChildDevice({
    ...
    try {
      ...
      debugPrint('✅ Child device notified of block rule changes');
    } catch (e) {
      debugPrint('⚠️ Error notifying child device: $e');
