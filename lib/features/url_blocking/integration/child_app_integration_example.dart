  ...
  static Future<void> initialize({
    ...
    try {
      ...
      _blockerService!.onUrlBlocked = (url, rule) {
        debugPrint('🚫 URL blocked: $url');
        debugPrint('   Reason: ${rule.reason ?? "Blocked by parent"}');
      ...
      debugPrint('✅ URL blocking initialized successfully with FCM support');
    } catch (e) {
      debugPrint('❌ Error initializing URL blocking: $e');
    }
  }
