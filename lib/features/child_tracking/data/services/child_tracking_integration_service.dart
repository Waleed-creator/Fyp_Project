...
class ChildTrackingIntegrationService {
  ...
  Future<void> initializeTracking({
    ...
    try {
      ...
      debugPrint('✅ Child tracking integration initialized');
    } catch (e) {
      debugPrint('❌ Error initializing child tracking: $e');
    }
  }
  ...
  Future<void> _handleUrlVisited(
    ...
    try {
      ...
      debugPrint('❌ Error handling URL visited: $e');
    }
  }
  ...
  Future<void> _handleAppUsageUpdated(
    ...
    try {
      ...
      debugPrint('❌ Error handling app usage updated: $e');
    }
  }
  ...
  Future<void> _handleAppLaunched(
    ...
    try {
      ...
      debugPrint('❌ Error handling app launched: $e');
    }
  }
  ...
  Future<void> startPeriodicSync({
    ...
    debugPrint('✅ Periodic sync started for child: $childId');
  }
  ...
  Future<void> stopTracking() async {
    try {
      ...
      debugPrint('✅ Child tracking stopped');
    } catch (e) {
      debugPrint('❌ Error stopping child tracking: $e');
    }
  }
}
