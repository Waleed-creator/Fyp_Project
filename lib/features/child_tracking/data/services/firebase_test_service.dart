...
class FirebaseTestService {
  ...
  Future<void> createSampleUrlData() async {
    try {
      ...
      debugPrint('🚀 Creating sample URL data for child: $childId');
      ...
      for (int i = 0; i < sampleUrls.length; i++) {
        ...
        debugPrint('✅ URL uploaded: ${urlData['url']}');
      }

      debugPrint('✅ All URL data uploaded successfully!');
    } catch (e) {
      debugPrint('❌ Error creating URL data: $e');
    }
  }
  ...
  Future<void> createSampleAppData() async {
    try {
      ...
      debugPrint('🚀 Creating sample app usage data for child: $childId');
      ...
      for (int i = 0; i < sampleApps.length; i++) {
        ...
        final appId =
            'app_${appData['packageName']}_${DateTime.now().millisecondsSinceEpoch}';
        ...
        debugPrint('✅ App usage uploaded: ${appData['appName']}');
      }

      debugPrint('✅ All app usage data uploaded successfully!');
    } catch (e) {
      debugPrint('❌ Error creating app usage data: $e');
    }
  }
  ...
  Future<void> createAllSampleData() async {
    try {
      debugPrint('🚀 Creating all sample data...');

      await createSampleUrlData();
      await createSampleAppData();

      debugPrint('✅ All sample data created successfully!');
    } catch (e) {
