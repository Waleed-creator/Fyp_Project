...
class LocationRemoteDataSourceImpl implements LocationRemoteDataSource {
  ...
  Future<void> updateChildLocation({
    ...
    try {
      debugPrint('📍 [LocationRemote] Updating child location...');
      debugPrint(
        '📍 [LocationRemote] Path: parents/$parentId/children/$childId/location/current',
      );
      debugPrint(
        '📍 [LocationRemote] Location: ${location.latitude}, ${location.longitude}',
      );
      ...
      debugPrint('✅ [LocationRemote] Current location saved successfully');
      ...
      debugPrint('✅ [LocationRemote] Location history updated');
    } catch (e) {
      debugPrint('❌ [LocationRemote] Failed to update child location: $e');
