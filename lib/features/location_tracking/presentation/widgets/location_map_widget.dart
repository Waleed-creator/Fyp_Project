        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(fontSize: mq.sp(0.05), color: Colors.grey[600]),
            ),
            SizedBox(height: mq.h(0.01)),
            Text(
              'Child location tracking is disabled',
              style: TextStyle(fontSize: mq.sp(0.04), color: Colors.grey[500]),
            ),
          ],
        ),
      );
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Icon(Icons.person, color: AppColors.darkCyan, size: 24),
            ...
            child: ClipRRect(
              ...
              child: GoogleMap(
                onMapCreated: (GoogleMapController controller) {
                  ...
                  debugPrint(
                    '🗺️ [LocationMap] GoogleMap created successfully',
                  );
                },
