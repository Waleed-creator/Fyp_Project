...
class GeofenceConfigurationScreen extends StatefulWidget {
  ...
  @override
  State<GeofenceConfigurationScreen> createState() =>
      _GeofenceConfigurationScreenState();
}

class _GeofenceConfigurationScreenState
    extends State<GeofenceConfigurationScreen> {
    ...
    setState(() {
      _geofenceCircles = {
        Circle(
          ...
          radius: _radius,
          fillColor: AppColors.darkCyan.withValues(alpha: 0.2),
  ...
  Future<void> _saveGeofence() async {
    ...
    try {
      ...
      debugPrint(
        '✅ Geofence saved to: parents/${widget.parentId}/children/${widget.childId}/location/geofences/zones/${docRef.id}',
      );
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
              ...
              children: [
                ...
                if (!_isEditingRadius) ...[
                  ...
                  Slider(
                    ...
                    inactiveColor: AppColors.darkCyan.withValues(alpha: 0.3),
          ...
          // Save Button
          Container(
            margin: EdgeInsets.fromLTRB(mq.w(0.04), 0, mq.w(0.04), mq.h(0.02)),
