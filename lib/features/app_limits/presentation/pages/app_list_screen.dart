      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: _showUserAppsOnly
                ? 'Show All Apps'
                : 'Show User Apps Only',
          ),
          IconButton(
            icon: Icon(
              _showUsageStats ? Icons.analytics : Icons.analytics_outlined,
            ),
            onPressed: () {
              setState(() {
  ...
  Widget _buildAppCard(InstalledApp app, AppUsageStats? usageStats) {
    return Card(
      ...
      child: ListTile(
        ...
        title: Text(app.appName, style: TextStyle(fontWeight: FontWeight.w500)),
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow(
                'Version Code',
                app.versionCode?.toString() ?? 'Unknown',
              ),
              ...
              if (_showUsageStats && usageStats != null) ...[
                ...
                _buildDetailRow(
                  'Launch Count',
                  usageStats.launchCount.toString(),
                ),
                _buildDetailRow('Last Used', usageStats.formattedLastUsed),
                if (usageStats.lastTimeUsed.millisecondsSinceEpoch > 0)
                  _buildDetailRow(
                    'Last Used Date',
                    _formatDate(usageStats.lastTimeUsed),
                  ),
              ],
            ],
          ),
