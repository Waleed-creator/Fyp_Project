...
class ChildInstalledAppsScreen extends StatefulWidget {
  ...
  @override
  State<ChildInstalledAppsScreen> createState() =>
      _ChildInstalledAppsScreenState();
}
...
class _ChildInstalledAppsScreenState extends State<ChildInstalledAppsScreen> {
  ...
  Future<void> _loadInstalledApps() async {
    ...
    try {
      debugPrint('📱 [ChildInstalledAppsScreen] Loading installed apps...');
      ...
      debugPrint('✅ [ChildInstalledAppsScreen] Loaded ${apps.length} apps');
    } catch (e) {
      debugPrint('❌ [ChildInstalledAppsScreen] Error loading apps: $e');
      setState(() {
        _isLoading = false;
      });
                          ...
                          PopupMenuItem(
                            ...
                            child: Row(
                              children: [
                                ...
                                const Text('All Apps'),
                                if (_filterType == 'all') const Spacer(),
                                if (_filterType == 'all')
                                  const Icon(
                                    Icons.check,
                                    size: 16,
                          ...
                          PopupMenuItem(
                            ...
                            child: Row(
                              children: [
                                ...
                                if (_filterType == 'user') const Spacer(),
                                if (_filterType == 'user')
                                  const Icon(
                                    Icons.check,
                                    size: 16,
                          ...
                          PopupMenuItem(
                            ...
                            child: Row(
                              children: [
                                ...
                                if (_filterType == 'system') const Spacer(),
      ...
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            ...
            const SizedBox(width: 12),
            Expanded(
              child: Text(app.appName, style: const TextStyle(fontSize: 18)),
            ),
          ],
        ),
    ...
    try {
      ...
      if (childId == null || parentId == null) {
        ...
        messenger.showSnackBar(
          const SnackBar(
            content: Text(
              '❌ Child or Parent ID not found. Please login again.',
            ),
            backgroundColor: Colors.red,
          ),
        );
      ...
      debugPrint(
        '📱 [ChildInstalledAppsScreen] Syncing ${_allApps.length} apps to Firebase...',
      );
      ...
      messenger.showSnackBar(
        SnackBar(
          content: Text(
            '✅ Successfully synced ${_allApps.length} apps to Firebase!',
          ),
      ...
      debugPrint('✅ [ChildInstalledAppsScreen] Apps synced successfully');
    } catch (e) {
      navigator.pop(); // Close loading
      debugPrint('❌ [ChildInstalledAppsScreen] Error syncing apps: $e');
