...
class ParentChildDataService {
  ...
  Future<List<AppUsageFirebase>> getChildTodayAppUsage({
    ...
    try {
      ...
      debugPrint('❌ [ParentChildDataService] Error getting today app usage: $e');
      return [];
    }
  }
  ...
  Future<int> getChildTodayScreenTime({
    ...
    try {
      ...
      debugPrint('❌ [ParentChildDataService] Error getting today screen time: $e');
      return 0;
    }
  }
  ...
  Future<int> getChildInstalledAppsCount({
    ...
    try {
      ...
      debugPrint('❌ [ParentChildDataService] Error getting installed apps count: $e');
      return 0;
    }
  }
  ...
  Future<List<InstalledAppFirebase>> getChildInstalledApps({
    ...
    try {
      ...
      debugPrint('❌ [ParentChildDataService] Error getting installed apps: $e');
      return [];
    }
  }
