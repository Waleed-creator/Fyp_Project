...
class ChildLimitsService {
  ...
  void initialize({required String childId, required String parentId}) {
    _childId = childId;
    _parentId = parentId;
    debugPrint('✅ [ChildLimitsService] Initialized for child: $childId');
  }
  ...
  Future<Map<String, dynamic>?> getAppLimit(String packageName) async {
    if (_childId == null || _parentId == null) {
      debugPrint('❌ [ChildLimitsService] Not initialized');
      return null;
    }
    ...
    try {
      ...
      debugPrint('❌ [ChildLimitsService] Error getting app limit: $e');
      return null;
    }
  }
  ...
  Future<Map<String, dynamic>?> getGlobalScreenTimeLimit() async {
    ...
    try {
      ...
      debugPrint(
        '❌ [ChildLimitsService] Error getting global screen time limit: $e',
      );
      return null;
    }
  }
  ...
  Future<int> getTodayScreenTime() async {
    ...
    try {
      ...
      debugPrint('❌ [ChildLimitsService] Error getting today screen time: $e');
      return 0;
    }
  }
