...
class AppUsageFirebaseService {
  ...
  Future<void> uploadAppUsageToFirebase({
    ...
    try {
      ...
      debugPrint('✅ App usage uploaded to Firebase: $appName');
    } catch (e) {
      debugPrint('❌ Error uploading app usage to Firebase: $e');
      rethrow;
    }
  }
  ...
  Future<void> updateAppUsageInFirebase({
    ...
    try {
      ...
      debugPrint('✅ App usage updated in Firebase: $appId');
    } catch (e) {
      debugPrint('❌ Error updating app usage in Firebase: $e');
      rethrow;
    }
  }
  ...
  Future<void> batchUploadAppUsage({
    ...
    try {
      ...
      await batch.commit();
      debugPrint('✅ Batch uploaded ${appUsages.length} app usages to Firebase');
    } catch (e) {
      debugPrint('❌ Error batch uploading app usages: $e');
      rethrow;
    }
  }
