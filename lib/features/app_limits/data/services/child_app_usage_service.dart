...
class ChildAppUsageService {
  ...
  Future<void> uploadAppUsage({
    ...
    try {
      ...
      debugPrint('✅ Child app usage uploaded to Firebase: $appName');
    } catch (e) {
      debugPrint('❌ Error uploading child app usage: $e');
  ...
  Future<void> updateAppUsage({
    ...
    try {
      ...
      debugPrint('✅ Child app usage updated in Firebase: $appId');
    } catch (e) {
      debugPrint('❌ Error updating child app usage: $e');
    }
  }
  ...
  Future<void> batchUploadAppUsage({
    ...
    try {
      ...
      debugPrint('✅ Child batch uploaded ${appUsages.length} app usages to Firebase');
    } catch (e) {
      debugPrint('❌ Error batch uploading child app usages: $e');
    }
  }
