...
class ScreenTimeFirebaseService {
  ...
  Future<void> updateDailyScreenTime({
    ...
    try {
      ...
      debugPrint('✅ Daily screen time updated: $totalScreenTimeMinutes minutes for $dateStr');
    } catch (e) {
      debugPrint('❌ Error updating daily screen time: $e');
      rethrow;
    }
  }
  ...
  Future<void> calculateAndUpdateTotalScreenTime({
    ...
    try {
      ...
      debugPrint('✅ Calculated total screen time: $totalMinutes minutes');
    } catch (e) {
    debugPrint('❌ Error calculating total screen time: $e');
      rethrow;
    }
  }
