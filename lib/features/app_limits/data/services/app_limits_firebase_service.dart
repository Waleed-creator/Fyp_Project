...
class AppLimitsFirebaseService {
  ...
  Future<void> setAppLimit({
    ...
    try {
      ...
      debugPrint('✅ App limit set in Firebase: $appName - $dailyLimitMinutes minutes/day');
    } catch (e) {
      debugPrint('❌ Error setting app limit in Firebase: $e');
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>?> getAppLimit({
    ...
    try {
      ...
      debugPrint('❌ Error getting app limit from Firebase: $e');
      return null;
    }
  }
  ...
  Future<void> clearAppLimit({
    ...
    try {
      ...
      debugPrint('✅ App limit cleared in Firebase: $packageName');
    } catch (e) {
      debugPrint('❌ Error clearing app limit in Firebase: $e');
      rethrow;
    }
  }
  ...
  Future<void> setGlobalScreenTimeLimit({
    ...
    try {
      ...
      debugPrint('✅ Global screen time limit set: $dailyLimitMinutes minutes/day');
    } catch (e) {
      debugPrint('❌ Error setting global screen time limit: $e');
      rethrow;
    }
  }
  ...
  Future<Map<String, dynamic>?> getGlobalScreenTimeLimit({
    ...
    try {
      ...
      debugPrint('❌ Error getting global screen time limit: $e');
      return null;
    }
  }
  ...
  Future<void> clearGlobalScreenTimeLimit({
    ...
    try {
      ...
      debugPrint('✅ Global screen time limit cleared');
    } catch (e) {
      debugPrint('❌ Error clearing global screen time limit: $e');
      rethrow;
    }
  }
}
