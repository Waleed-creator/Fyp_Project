...
class _SOSEmergencyScreenState extends State<SOSEmergencyScreen> {
  ...
  Future<void> _triggerSOS() async {
    ...
    try {
      ...
      if (parentId == null) {
        _showError(
          'Parent not found. Please ensure you are linked to a parent account.',
        );
        setState(() {
          _isSending = false;
        });
      ...
      try {
        ...
        debugPrint(
          '✅ SOS: Location obtained - ${position.latitude}, ${position.longitude}',
        );
        ...
        try {
          ...
          if (placemarks.isNotEmpty) {
            ...
            debugPrint('✅ SOS: Address geocoded - $address');
          }
        } catch (e) {
          debugPrint('⚠️ SOS: Error geocoding address: $e');
          address =
              'Location: ${position.latitude.toStringAsFixed(6)}, ${position.longitude.toStringAsFixed(6)}';
        }
      } catch (e) {
        debugPrint('⚠️ SOS: Error getting location: $e');
        _showError(
          'Could not get location. SOS alert will be sent without location.',
        );
      ...
      debugPrint('✅ SOS: Alert sent to parent with location');
