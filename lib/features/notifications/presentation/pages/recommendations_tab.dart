...
//   const RecommendationsTab({super.key, required this.parentId});
...
//   Timer? _timer;
//   DateTime?
//   _nextGenerationTime; // Store the absolute time when next generation should happen
...
//       debugPrint('🔄 [RecommendationsTab] App resumed - reloading timer');
...
//         debugPrint(
//           '⏰ [RecommendationsTab] Loaded saved time: $_nextGenerationTime',
//         );
//         debugPrint('   Current time: $now');
//         debugPrint(
//           '   Remaining: ${_nextGenerationTime!.difference(now).inMinutes} minutes',
//         );

//         // If saved time has passed, generate immediately
//         if (_nextGenerationTime!.isBefore(now) ||
//             _nextGenerationTime!.isAtSameMomentAs(now)) {
//           debugPrint(
//             '⏰ [RecommendationsTab] Saved time has passed, generating now...',
//           );
...
//         final lastGenTime = await _recommendationService
//             .getLastGenerationTimestamp(widget.parentId);
//         final now = DateTime.now();
...
//           debugPrint(
//             '⏰ [RecommendationsTab] Using Firebase timestamp - next generation at: $_nextGenerationTime',
//           );
//         } else {
//           // First time ever - set next generation to 6 hours from now
//           _nextGenerationTime = now.add(const Duration(hours: 6));
//           debugPrint(
//             '⏰ [RecommendationsTab] First time setup - next generation at: $_nextGenerationTime',
//           );
//         }
...
//       setState(() {});
//     } catch (e) {
//       debugPrint('❌ [RecommendationsTab] Error loading timer: $e');
...
//         savedTimeKey,
//         _nextGenerationTime!.toIso8601String(),
//       );

//       debugPrint(
//         '💾 [RecommendationsTab] Saved next generation time: $_nextGenerationTime',
//       );
//     } catch (e) {
//       debugPrint('❌ [RecommendationsTab] Error saving timer: $e');
//     }
//   }
...
//     try {
//       debugPrint('🤖 [RecommendationsTab] Auto-generating recommendations...');
//       await _generateRecommendations();

//       // After generation, set next generation time to 6 hours from now
//       _nextGenerationTime = DateTime.now().add(const Duration(hours: 6));
//       debugPrint(
//         '⏰ [RecommendationsTab] Next generation scheduled at: $_nextGenerationTime',
//       );
...
//       setState(() {});
//     } catch (e) {
//       debugPrint('❌ [RecommendationsTab] Error in auto-generation: $e');
//     } finally {
//       _isGenerating = false;
//       setState(() {});
//     }
...
//           debugPrint(
//             '📱 [RecommendationsTab] Children snapshot received: ${childrenSnapshot.docs.length} children',
//           );

//           if (childrenSnapshot.docs.isEmpty) {
//             debugPrint(
//               '⚠️ [RecommendationsTab] No children found, returning empty list',
//             );
...
//               debugPrint(
//                 '📱 [RecommendationsTab] Found ${recommendationsSnapshot.docs.length} recommendations for child $childId',
//               );
...
//                       } catch (e) {
//                         debugPrint(
//                           '❌ [RecommendationsTab] Error parsing recommendation ${doc.id}: $e',
//                         );
//                         return null;
//                       }
//                     })
...
//             } catch (e) {
//               debugPrint(
//                 '⚠️ [RecommendationsTab] Error fetching recommendations for child $childId: $e',
//               );
...
//           debugPrint(
//             '✅ [RecommendationsTab] Total recommendations: ${allRecommendations.length}',
//           );
//           return allRecommendations;
//         })
//         .handleError((error) {
//           debugPrint('❌ [RecommendationsTab] Stream error: $error');
//           return <RecommendationModel>[];
//         });
//   }
...
//             children: [
//               const Icon(Icons.schedule, color: AppColors.darkCyan, size: 20),
...
//               debugPrint(
//                 '📱 [RecommendationsTab] Building UI with ${allRecommendations.length} recommendations',
//               );
...
//       'MMM d, y • h:mm a',
//     ).format(recommendation.timestamp);
...
//     try {
//       await _recommendationService.generateRecommendationsForAllChildren(
//         widget.parentId,
//       );
