...
class FirestoreNotificationListener {
  ...
  Future<void> startListening() async {
    try {
      ...
      if (currentUser == null) {
        debugPrint('⚠️ [FirestoreListener] User not logged in');
        return;
      }
      ...
      debugPrint(
        '🔔 [FirestoreListener] Starting listener for parent: $parentId',
      );
      ...
      if (childrenSnapshot.docs.isEmpty) {
        debugPrint('⚠️ [FirestoreListener] No children found');
        return;
      }
      ...
      final parentNotificationsSubscription = _firestore
          ...
          .where(
            'isRead',
            isEqualTo: false,
          ) // Only listen to unread notifications
              ...
              if (_lastNotificationId != notificationId) {
                ...
                try {
                  ...
                  if (!notification.isRead) {
                    ...
                    debugPrint(
                      '✅ [FirestoreListener] Parent notification shown: ${notification.title}',
                    );
                  } else {
                    debugPrint(
                      '⏭️ [FirestoreListener] Parent notification already read, skipping: ${notification.title}',
                    );
                  }
                } catch (e) {
                  debugPrint(
                    '❌ [FirestoreListener] Error parsing parent notification: $e',
                  );
                }
              }
            }
                ...
                if (_lastNotificationId != notificationId) {
                  ...
                  try {
                    ...
                    if (!notification.isRead) {
                      _showLocalNotification(notification);
                      debugPrint(
                        '✅ [FirestoreListener] Child notification shown: ${notification.title}',
                      );
                    } else {
                      debugPrint(
                        '⏭️ [FirestoreListener] Child notification already read, skipping: ${notification.title}',
                      );
                    }
                  } catch (e) {
                    debugPrint(
                      '❌ [FirestoreListener] Error parsing child notification: $e',
                    );
                  }
                }
              }
      ...
      debugPrint('✅ [FirestoreListener] Listening started');
    } catch (e) {
      debugPrint('❌ [FirestoreListener] Error starting listener: $e');
    }
  }
  ...
  void stopListening() {
    ...
    debugPrint('🛑 [FirestoreListener] Stopped listening');
  }
  ...
  Future<void> _showLocalNotification(NotificationModel notification) async {
    try {
      ...
      debugPrint(
        '✅ [FirestoreListener] Local notification shown: ${notification.title}',
      );
    } catch (e) {
      debugPrint('❌ [FirestoreListener] Error showing notification: $e');
    }
  }
}
