...
//     try {
//       debugPrint('🤖 [RecommendationService] Generating recommendations for all children...');
...
//         debugPrint('⚠️ [RecommendationService] No children found');
//         return;
//       }

//       debugPrint('📱 [RecommendationService] Found ${childrenSnapshot.docs.length} children');
...
//         debugPrint('🤖 [RecommendationService] Generating recommendation for: $childName ($childId)');
...
//       debugPrint('✅ [RecommendationService] Recommendations generated for all children');
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error generating recommendations: $e');
//     }
//   }
...
//       });
//       debugPrint('✅ [RecommendationService] Last generation timestamp saved');
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error saving timestamp: $e');
//     }
//   }
...
//       return null;
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error getting timestamp: $e');
//       return null;
//     }
//   }
...
//         debugPrint('⚠️ [RecommendationService] No data available for child: $childName');
//         return false;
//       }
...
//       debugPrint('👤 [RecommendationService] Using child name: $finalChildName');

//       // Generate AI recommendation
//       final recommendation = await _generateAIRecommendation(childData, finalChildName);
      
//       if (recommendation.isEmpty) {
//         debugPrint('⚠️ [RecommendationService] Empty recommendation generated');
//         return false;
//       }
...
//       debugPrint('✅ [RecommendationService] Recommendation generated and saved for: $finalChildName');
//       return true;
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error generating recommendation for child: $e');
//       return false;
//     }
//   }
...
//         debugPrint('⚠️ [RecommendationService] OpenAI API key not configured');
//         return '';
//       }
...
//       } else {
//         debugPrint('❌ [RecommendationService] OpenAI API error: ${response.statusCode}');
//         debugPrint('Response: ${response.body}');
//         return '';
//       }
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error calling AI: $e');
//       return '';
//     }
//   }
...
//       debugPrint('✅ [RecommendationService] Recommendation saved to Firebase');
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error saving recommendation: $e');
//       rethrow;
//     }
//   }
...
//       debugPrint('✅ [RecommendationService] Notification sent to parent');
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error sending notification: $e');
//     }
//   }
...
//       debugPrint('✅ [RecommendationService] Summary notification sent: $body');
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error sending summary notification: $e');
//     }
//   }
...
//       debugPrint('✅ [RecommendationService] Recommendation approved');
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error approving recommendation: $e');
//       rethrow;
//     }
//   }
...
//       debugPrint('✅ [RecommendationService] Recommendation rejected');
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error rejecting recommendation: $e');
//       rethrow;
//     }
//   }
...
//       debugPrint('✅ [RecommendationService] Recommendation deleted');
//     } catch (e) {
//       debugPrint('❌ [RecommendationService] Error deleting recommendation: $e');
//       rethrow;
//     }
//   }
// }
