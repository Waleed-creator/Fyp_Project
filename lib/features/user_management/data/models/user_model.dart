...
class UserModel extends UserEntity {
  ...
  Map<String, dynamic>? generateFamilyInviteQRData(String familyId) {
    ...
    debugPrint('User type lowercase: "${userType.toLowerCase()}"');
    debugPrint('Is parent: ${userType.toLowerCase() == 'parent'}');

    if (userType.toLowerCase() != 'parent') {
      debugPrint('Cannot generate family invite: User is not a parent');
