...
class LocationTrackingService {
  ...
  Future<void> startLocationTracking({
    ...
    try {
      ...
      debugPrint('Location tracking started for child: $childId');
    } catch (e) {
  ...
  Future<void> _updateChildLocation({
    ...
    try {
      ...
      debugPrint('Location updated for child $childId: ${position.latitude}, ${position.longitude}');
    } catch (e) {
      debugPrint('Error updating child location: $e');
      await _updateLocationStatus(parentId, childId, 'offline');
    }
  }
