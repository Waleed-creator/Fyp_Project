...
class DeleteChildService {
  ...
  Future<bool> deleteChild({
    ...
    try {
      debugPrint('🗑️ [DeleteChild] Starting deletion for child: $childId');
      ...
      if (name == null) {
        try {
          ...
          debugPrint('⚠️ [DeleteChild] Could not fetch child name: $e');
          name = 'Child';
        }
      }
      ...
      debugPrint('✅ [DeleteChild] Notification shown immediately');
      ...
      if (childDoc.exists) {
        ...
        debugPrint('✅ [DeleteChild] Child document deleted');
        
        // Verify deletion
        final verifyDoc = await childDocRef.get();
        if (verifyDoc.exists) {
          debugPrint('⚠️ [DeleteChild] WARNING: Child document still exists after deletion! Retrying...');
          // Retry deletion
          await childDocRef.delete();
          // Verify again
          final verifyDoc2 = await childDocRef.get();
          if (verifyDoc2.exists) {
            debugPrint('❌ [DeleteChild] ERROR: Child document still exists after retry!');
            throw Exception('Failed to delete child document after retry');
          }
        }
      } else {
        debugPrint('⚠️ [DeleteChild] Child document does not exist (may have been already deleted)');
      }
      ...
      debugPrint('✅ [DeleteChild] Child ID removed from parent\'s childrenIds array');

      // 13. Clear child's local data
      await _clearChildLocalData(childId).catchError((e) {
        debugPrint('⚠️ [DeleteChild] Error clearing local data: $e');
      });
      ...
      await _cleanupOrphanedChildrenIds(parentId).catchError((e) {
        debugPrint('⚠️ [DeleteChild] Error cleaning up orphaned childrenIds: $e');
      });

      debugPrint('✅ [DeleteChild] Child $childId deleted successfully');
      return true;
    } catch (e) {
      debugPrint('❌ [DeleteChild] Error deleting child: $e');
      return false;
    }
  }
  ...
  Future<void> _cleanupOrphanedChildrenIds(String parentId) async {
    try {
      ...
      if (orphanedIds.isNotEmpty || missingIds.isNotEmpty) {
        debugPrint('🔧 [DeleteChild] Cleaning up childrenIds array...');
        debugPrint('   Orphaned IDs (removing): $orphanedIds');
        debugPrint('   Missing IDs (adding): $missingIds');
        ...
        debugPrint('✅ [DeleteChild] childrenIds array synced with actual documents');
      }
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error cleaning up orphaned childrenIds: $e');
  ...
  Future<void> _deleteLocationData(String parentId, String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] Location data deleted');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error deleting location data: $e');
    }
  }
  ...
  Future<void> _deleteFlaggedMessages(String parentId, String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] Flagged messages deleted');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error deleting flagged messages: $e');
    }
  }
  ...
  Future<void> _deleteGeofenceData(String parentId, String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] Geofence data deleted');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error deleting geofence data: $e');
    }
  }
  ...
  Future<void> _deleteMessages(String parentId, String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] General messages deleted');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error deleting general messages: $e');
    }
  }
  ...
  Future<void> _deleteFlaggedCalls(String parentId, String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] Flagged calls deleted');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error deleting flagged calls: $e');
    }
  }
  ...
  Future<void> _deleteCallLogs(String parentId, String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] Call logs deleted');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error deleting call logs: $e');
    }
  }
  ...
  Future<void> _deleteUrlTrackingData(String parentId, String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] URL tracking data deleted');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error deleting URL tracking data: $e');
    }
  }
  ...
  Future<void> _deleteAppUsageData(String parentId, String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] App usage data deleted');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error deleting app usage data: $e');
    }
  }
  ...
  Future<void> _deleteWatchList(String parentId, String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] Watch list deleted');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error deleting watch list: $e');
    }
  }
  ...
  Future<void> _deleteBlockedUrls(String parentId, String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] Blocked URLs deleted');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error deleting blocked URLs: $e');
    }
  }
  ...
  Future<void> _clearChildLocalData(String childId) async {
    try {
      ...
      debugPrint('✅ [DeleteChild] Local data cleared');
    } catch (e) {
      debugPrint('⚠️ [DeleteChild] Error clearing local data: $e');
    }
  }
  ...
  Future<void> _showDeleteNotification(String childName) async {
    try {
      ...
      if (androidImplementation != null) {
        ...
        debugPrint('✅ [DeleteChild] Notification channel created');
      }
      ...
      debugPrint('✅ [DeleteChild] Notification shown: $childName deleted');
    } catch (e) {
      debugPrint('❌ [DeleteChild] Error showing notification: $e');
    }
  }
}
