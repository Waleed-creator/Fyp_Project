...
class _ParentHomeScreenState extends State<ParentHomeScreen> {
  ...
  Future<void> _startNotificationListener() async {
    try {
      ...
      debugPrint('✅ [ParentHome] Firestore notification listener started');
    } catch (e) {
      debugPrint('❌ [ParentHome] Error starting notification listener: $e');
    }
  }
  ...
  void _setupRealtimeListener() {
    ...
    if (currentUser != null) {
      _childrenStream = FirebaseFirestore.instance
        ...
        debugPrint('🔄 [ParentHome] Real-time update: ${snapshot.docs.length} children');
