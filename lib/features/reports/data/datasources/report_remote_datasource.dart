...
abstract class ReportRemoteDataSource {
  ...
  Future<void> saveReportMetadata({required ReportModel report});
...
class ReportRemoteDataSourceImpl implements ReportRemoteDataSource {
  ...
  Future<ReportDataModel> fetchReportData({
    ...
    try {
      ...
      try {
        ...
        debugPrint('Error fetching geofence events: $e');
      }
      ...
      try {
        final callLogsSnapshot = await firestore
            ...
            .where(
              'dateTime',
              isLessThanOrEqualTo: endDateWithTime.millisecondsSinceEpoch,
            )
  ...
  @override
  Future<void> saveReportMetadata({required ReportModel report}) async {
    try {
      await firestore
          .collection('parents')
          .doc(report.parentId)
