  ...
  factory CallAlertModel.fromMap(Map<String, dynamic> map) {
    try {
      ...
      DateTime parseTimestamp(dynamic timestamp) {
        if (timestamp == null) {
          debugPrint('⚠️ [CallAlertModel] Timestamp is null, using current time');
          return DateTime.now();
        }
        ...
        if (timestamp is Timestamp) {
          ...
          try {
            ...
            debugPrint('⚠️ [CallAlertModel] Error parsing timestamp string: $e');
            return DateTime.now();
          }
          ...
          debugPrint('⚠️ [CallAlertModel] Unknown timestamp type: ${timestamp.runtimeType}');
          return DateTime.now();
        }
      }
      ...
      debugPrint('❌ [CallAlertModel] Error in fromMap: $e');
